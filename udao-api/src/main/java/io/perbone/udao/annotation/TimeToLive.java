...
import static io.perbone.udao.annotation.Metadata.MetadataType.TIME_TO_LIVE;
...
public @interface TimeToLive
{
    ...
    /**
     * Indicates to leave a void note on time to live expiration event. Defaults to false.
     */
    boolean leaveVoid() default false;
}