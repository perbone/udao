UDAO - Universal Data Access Object [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0) 
======

> WIP (heavily updated so you can expect constants changes - no commitment with feature freezing at this moment)

Framework for multiple data sources and distributed caching

## Features

* Support for JDBC data sources
* Support for Berkeley DB JE data sources
* L1 In-memory caching
* L2 Data-grid caching

## Issues and Support

Have a bug? Please create an issue here on GitHub!

https://github.com/perbone/udao/issues
